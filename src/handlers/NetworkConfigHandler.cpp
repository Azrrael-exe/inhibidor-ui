...
void initNetworkConfigHandler(const uint8_t* mac, ActivityWatchdog* watchdog, int channelId) {
    s_mac           = mac;
    s_watchdog      = watchdog;
...
// GET /config/network
// Returns the persisted network configuration (EEPROM) and the live IP/MAC.
